...
import { Phone, MessageCircle, Mail, User, MapPin, Building, Send, Map, CheckSquare, Edit3, Clock, Sparkles, ChevronDown } from "lucide-react";
...
function Contact() {
  ...
  const optionsList = [
    ...
    },
    {
      ...
      label: <span className="text-slate-800 font-bold">{isEn ? "1 Day Tour Pass" : "१ दिवस सहल पास"}</span>,
    },
    {
      value: isEn ? "Day-Care Monthly Pass" : "डे-केअर मासिक पास",
      label: <span className="text-slate-800 font-bold">{isEn ? "Day-Care Monthly Pass" : "डे-केअर मासिक पास"}</span>,
    },
    {
    ...
    },
    {
      ...
      label: <span className="text-slate-800 font-bold">{isEn ? "Sports Club Membership" : "स्पोर्ट्स क्लब मेंबरशिप"}</span>,
    },
  ];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    addInquiry({ name, phone, email, subject: subject || "आनंदशाळा प्रवेश चौकशी", message, category: inquiryCategory });
    setSubmitted(true);
    setName("");
    setPhone("");
    setEmail("");
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f8fafc] via-[#fff5f9] to-[#f0f4ff] font-sans pb-20">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 space-y-12">
        ...
        {/* ══════════════════════════════════════════════════════════════
           ...
           ══════════════════════════════════════════════════════════════ */}
        <div className="max-w-[620px] mx-auto grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-3.5">
          ...
          >
            <div className="shrink-0 w-10 h-10 sm:w-11 sm:h-11 rounded-2xl bg-gradient-to-br from-pink-500 to-rose-600 flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform">
              <Phone size={20} />
            </div>
            <div className="overflow-hidden min-w-0">
              ...
              <p className="text-xs sm:text-sm font-black text-[#be185d] tracking-wide whitespace-nowrap group-hover:text-pink-600 transition-colors">+91-9370237633</p>
            </div>
          </a>
          ...
          >
            <div className="shrink-0 w-10 h-10 sm:w-11 sm:h-11 rounded-2xl bg-gradient-to-br from-purple-600 to-indigo-700 flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform">
              <Building size={20} />
            </div>
            <div className="overflow-hidden min-w-0">
              <p className="text-[11px] sm:text-xs font-black text-slate-500 mb-0.5 truncate">{isEn ? "Office Contact" : "कार्यालय संपर्क"}</p>
              <p className="text-xs sm:text-sm font-black text-[#1A05A2] tracking-wide whitespace-nowrap group-hover:text-purple-600 transition-colors">+91-9423258859</p>
            </div>
          </a>
          ...
          >
            <div className="shrink-0 w-10 h-10 sm:w-11 sm:h-11 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform">
              <MessageCircle size={20} />
            </div>
            <div className="overflow-hidden min-w-0">
              <p className="text-[11px] sm:text-xs font-black text-slate-500 mb-0.5 truncate">{isEn ? "WhatsApp Chat" : "चॅट WhatsApp"}</p>
              <p className="text-xs sm:text-sm font-black text-emerald-700 tracking-wide whitespace-nowrap group-hover:text-teal-600 transition-colors">+91-9370237633</p>
            </div>
          </a>
          ...
          >
            <div className="shrink-0 w-10 h-10 sm:w-11 sm:h-11 rounded-2xl bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform">
              <Mail size={20} />
            </div>
            <div className="overflow-hidden min-w-0">
              <p className="text-[11px] sm:text-xs font-black text-slate-500 mb-0.5 truncate">{isEn ? "Email Address" : "ई-मेल पत्ता"}</p>
              <p className="text-[11px] sm:text-xs font-black text-orange-600 tracking-tight truncate group-hover:text-amber-700 transition-colors" title={site.email}>{site.email}</p>
            </div>
          </a>
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-xl border-2 border-pink-200/80 overflow-hidden relative p-6 sm:p-7 space-y-5 transition-all hover:shadow-2xl hover:shadow-pink-100/50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-center border-b border-pink-100 pb-5">
            <div className="lg:col-span-5 flex items-center gap-3.5">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#db2777] to-[#9333ea] flex items-center justify-center text-white shrink-0 shadow-lg shadow-pink-200">
                <MapPin size={28} />
              </div>
              <div>
                ...
                <p className="text-xs font-bold text-slate-500 mt-0.5">
                  {isEn ? <>Preetam Senior Citizen <span className="text-[#db2777] font-black">Anandshala</span>, Sangli</> : <>प्रीतम ज्येष्ठ नागरिक <span className="text-[#db2777] font-black">आनंदशाळा</span>, सांगली</>}
                </p>
              </div>
            </div>

            <div className="lg:col-span-7 bg-gradient-to-br from-pink-50/80 via-purple-50/40 to-blue-50/80 rounded-2xl p-4 border border-pink-100/80 shadow-sm">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="text-xs font-black text-[#1A05A2] mb-0.5">{isEn ? "Official Postal Address" : "अधिकृत पत्ता"}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
            {/* Anandshala Center */}
            <div className="bg-gradient-to-br from-rose-50/90 to-pink-100/60 rounded-2xl p-4 border-2 border-rose-200/80 shadow-sm hover:shadow-md hover:scale-[1.02] transition-all flex items-center gap-3.5">
              <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-pink-500 to-rose-600 text-white flex items-center justify-center shadow-md shadow-pink-200 shrink-0">
                <Building size={22} />
              </div>
              <div className="min-w-0">
                <p className="text-xs font-black text-[#810B38]">
                  <span className="text-[#db2777] font-black">{isEn ? "Anandshala" : "आनंदशाळेचे"}</span>{isEn ? " Campus" : " केंद्र"}
                </p>
            ...
            {/* Office Center */}
            <div className="bg-gradient-to-br from-indigo-50/90 to-blue-100/60 rounded-2xl p-4 border-2 border-blue-200/80 shadow-sm hover:shadow-md hover:scale-[1.02] transition-all flex items-center gap-3.5">
              <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-[#1A05A2] to-indigo-600 text-white flex items-center justify-center shadow-md shadow-blue-200 shrink-0">
                <Building size={22} />
              </div>
              <div className="min-w-0">
            ...
            {/* Timings */}
            <div className="bg-gradient-to-br from-amber-50/90 to-orange-100/60 rounded-2xl p-4 border-2 border-amber-200/80 shadow-sm hover:shadow-md hover:scale-[1.02] transition-all flex items-center gap-3.5">
              <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 text-white flex items-center justify-center shadow-md shadow-amber-200 shrink-0">
                <Clock size={22} />
              </div>
              <div className="min-w-0">
                <p className="text-xs font-black text-amber-900">
                  <span className="text-[#db2777] font-black">{isEn ? "Anandshala" : "आनंदशाळा"}</span> {isEn ? "& Office Timings" : "व कार्यालय वेळ"}
                </p>
                  ...
                  >
                    ...
                    <span className="truncate">
                      {!subject ? (
                        ...
                        <>
                          <span className="text-[#db2777] font-black">{isEn ? "Anandshala" : "आनंदशाळा"}</span>
                          <span className="text-slate-800 font-bold">{isEn ? " Admission Inquiry" : " प्रवेश चौकशी"}</span>
                        </>
                      ) : (
                    ...
                    <div className={`absolute inset-y-0 right-0 pr-3.5 flex items-center pointer-events-none text-slate-400 transition-transform ${dropdownOpen ? "rotate-180 text-[#db2777]" : ""}`}>
                      <ChevronDown size={18} />
                    </div>
                  </button>
                  ...
                  {dropdownOpen && (
                    <div className="absolute left-0 right-0 top-full mt-1.5 bg-white rounded-2xl border-2 border-pink-100 shadow-2xl z-50 overflow-hidden py-1 animate-fade-in">
                      {optionsList.map((opt, idx) => (
                        ...
                        >
                          <div>{opt.label}</div>
                          {subject === opt.value && <Sparkles size={14} className="text-[#db2777]" />}
                        </div>
                      ))}
                    </div>
                  )}
        ...
        <div className="bg-white rounded-3xl shadow-xl border-2 border-blue-100 overflow-hidden relative p-5 sm:p-6 space-y-4 mb-8">
          <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-[#0ea5e9] via-[#0284c7] to-[#1A05A2]" />
          ...
          <div className="flex items-center justify-between border-b border-blue-100 pb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-slate-500">
                  {isEn ? <>Preetam Senior Citizen <span className="text-[#db2777] font-black">Anandshala</span> Campus</> : <>प्रीतम ज्येष्ठ नागरिक <span className="text-[#db2777] font-black">आनंदशाळा</span> परिसर</>}
                </p>
              </div>
            </div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hidden sm:inline-flex items-center gap-2 rounded-xl px-3.5 py-2 font-black text-xs text-white shadow-md hover:scale-105 transition-transform bg-gradient-to-r from-[#0ea5e9] to-[#0284c7]"
            >
              <Map size={15} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-center">
            ...
            <div className="lg:col-span-4 flex flex-col justify-center space-y-3">
              <div className="bg-slate-50 p-3 rounded-2xl border border-slate-200 text-center space-y-1">
                <p className="text-xs font-black text-[#1A05A2]">📍 {isEn ? "Direct Navigation" : "थेट नेव्हिगेशन"}</p>
                <p className="text-xs font-bold text-slate-600 leading-relaxed">
                  {isEn ? <><span className="text-[#db2777] font-black">Anandshala</span> campus navigation</> : <><span className="text-[#db2777] font-black">आनंदशाळा</span> संकुलात येण्यासाठी थेट गूगल मॅप्स नेव्हिगेशन वापरा.</>}
                </p>
              </div>
              <a
                href={sportsClub.googleMaps}
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center justify-center gap-2 rounded-2xl py-3 font-black text-xs sm:text-sm text-white shadow-lg hover:scale-[1.01] transition-transform cursor-pointer bg-gradient-to-r from-[#0ea5e9] to-[#0284c7]"
              >
                <Map size={16} />
