...
export function AboutSangli() {
  ...
  const rawPlaces: PlaceItem[] = [
    // ── WITHIN / VERY CLOSE TO SANGLI (Within 10 km) ──
    {
      ...
      shortDescEn:
        "Historic black-stone temple built in 1843; Sangli city's most iconic spiritual landmark.",
      fullDescMr:
        "पटवर्धन घराण्याने १८४३ मध्ये उभारलेले हे मंदिर वास्तुकलेचा अद्भूत नमुना आहे. कृष्णा नदीच्या घाटावर वसलेले हे मंदिर सांगलीचे मुख्य श्रद्धास्थान आहे. येथे पायऱ्यांची अडचण नसल्याने ज्येष्ठ नागरिकांसाठी अतिशय सोयीस्कर दर्शन आहे.",
      fullDescEn:
        "Constructed in 1843 by Patwardhan rulers, this black-stone shrine on Krishna river is Sangli's main landmark. Features smooth level access ideal for senior citizens.",
      highlightsMr: [
    ...
    },
    {
      ...
      shortDescEn:
        "Historical Patwardhan-era heritage palace, fountains and royal architecture in city heart.",
      fullDescMr:
        "सांगली शहराच्या मध्यभागी असलेला हा ऐतिहासिक राजवाडा पटवर्धन घराण्याच्या वैभवशाली परंपरेची साक्ष देतो. राजवाड्याचा परिसर, कारंजे आणि ऐतिहासिक वास्तू फिरण्यासाठी अतिशय आनंददायी आहे.",
      fullDescEn:
        "Located in the heart of Sangli city, this historic Patwardhan era palace compound offers peaceful heritage walking and royal architectural grandeur.",
      highlightsMr: [
    ...
    },
    {
      ...
      shortDescEn:
        "Peaceful spiritual Shiv temple at the serene confluence of Krishna and Warna rivers.",
      fullDescMr:
        "हरिपूर येथे कृष्णा आणि वारणा या दोन पवित्र नद्यांचा सुरेख संगम होतो. संगमावर असलेले संगमेश्वर (सिद्धेश्वर) मंदिर अत्यंत शांत अध्यात्मिक ऊर्जा देते. सकाळ-संध्याकाळ निवांत बसण्यासाठी हे उत्तम स्थान आहे.",
      fullDescEn:
        "Situated at the scenic confluence of Krishna and Warna rivers in Haripur, this Shiva temple offers tranquil waterfront views and deeply peaceful spiritual vibes.",
      highlightsMr: [
    ...
    },
    {
      ...
      fullDescMr:
        "१९२९ मध्ये बांधलेला आयर्विन पूल हा सांगलीचा ऐतिहासिक मानबिंदू आहे. कृष्णा नदीच्या पात्रातील हा पूल व लगतचा नदीकाठ सकाळी किंवा संध्याकाळी गाडीतून फिरण्यासाठी अतिशय आनंददायी आहे.",
      fullDescEn:
        "Built in 1929, the historic red-stone Irwin Bridge spans the Krishna River. Offers scenic driving and riverside viewing for quick morning or evening outings.",
      highlightsMr: [
    ...
    },
    {
      ...
      shortDescEn:
        "Important shared Hindu-Muslim pilgrimage site & world famous Sitar manufacturing hub.",
      fullDescMr:
        "मिरज येथील हजरत ख्वाजा शामना मीरा दर्गाह हे जातीय सलोखा व सर्वधर्मसमभावाचे मुख्य प्रतीक आहे. तसेच मिरज ही सतार आणि तंबोरा वाद्य निर्मितीची जागतिक राजधानी मानली जाते.",
      fullDescEn:
        "The Khwaja Meerasaheb Dargah in Miraj is a famous holy shrine visited by devotees of all faiths. Miraj is also India's GI-tagged hub for handcrafted Sitars & Tanpuras.",
      highlightsMr: [
    ...
    },
    {
      ...
      shortDescEn:
        "Sacred Shri Dattatreya temple on Krishna riverbank; excellent for a quiet spiritual outing.",
      fullDescMr:
        "श्री नरसिंह सरस्वती स्वामींच्या वास्तव्याने पुनीत झालेले औदुंबर हे महाराष्ट्रातील मुख्य दत्त क्षेत्रांपैकी एक आहे. कृष्णा नदीच्या शांत पात्रात स्नान व दत्त पादुका दर्शन मनःशांती देते.",
      fullDescEn:
        "Blessed by Shri Narasimha Saraswati, Audumbar is a premier Datta pilgrimage site. Nestled amidst lush Audumbar trees on Krishna riverbank, offering profound tranquility.",
      highlightsMr: [
    ...
    // ── WITHIN ROUGHLY 25-50 KM (२५ ते ५० किमी परिसर) ──
    {
      ...
      shortDescEn:
        "Hills, forest reserve, ancient cave temple and scenic views; ideal short morning outing.",
      fullDescMr:
        "सांगलीपासून २५ मिनिटांच्या अंतरावर दंडोबा टेकडी आहे. हे राखीव वनक्षेत्र असून येथे प्राचीन गुहेमध्ये भगवान शिवाचे स्थान आहे. गाडीने वरपर्यंत जाता येत असल्याने सकाळी फिरण्यासाठी उत्तम आहे.",
      fullDescEn:
        "Described as a 25-minute drive from Sangli, Dandoba Hills is a protected forest reserve with an ancient cave Shiva temple. Road reaches right up to temple area.",
      highlightsMr: [
    ...
    },
    {
      ...
      shortDescEn:
        "Unique man-made sanctuary with deer, blackbuck, peacocks, temples & Krishna river views.",
      fullDescMr:
        "सागरेश्वर हे भारतातील पहिले मानवनिर्मित अभयारण्य आहे. १०.८ चौ. किमी परिसरात १,००० पेक्षा जास्त हरणे, काळवीट व मोर मुक्तपणे फिरतात. येथे गाडीतून फिरत प्राणी पाहता येतात.",
      fullDescEn:
        "India's pioneer man-made wildlife reserve spanning 10.8 sq km. Home to 1,000+ deer, blackbucks, peacocks with driving tracks and ancient Shiva cave shrines.",
      highlightsMr: [
    ...
    },
    {
      ...
      shortDescEn:
        "Renowned Jain pilgrimage center with 28ft Bahubali statue & panoramic valley views.",
      fullDescMr:
        "कुंभोज येथील बाहुबली हे प्रसिद्ध जैन तीर्थक्षेत्र आहे. टेकडीवर २८ फुटांची भगवान बाहुबलींची भव्य मूर्ती आहे. टीप: टेकडीवर जाण्यासाठी सुमारे ४०० पायऱ्या असल्याने चालणे टाळणाऱ्या ज्येष्ठ नागरिकांसाठी हे थोडे आव्हानात्मक असू शकते.",
      fullDescEn:
        "Major Jain pilgrimage hub featuring a 28ft tall Lord Bahubali statue atop a hill. Note: Involves ~400 steps climb, so recommended for active seniors.",
      highlightsMr: [
    ...
    },
    {
      ...
      shortDescEn:
        "Attractive Krishna river island location with ancient Ram temple; ideal for nature outing.",
      fullDescMr:
        "वाळवा तालुक्यातील बहे येथे कृष्णा नदीच्या पात्रात निसर्गरम्य रामलिंग बेट आहे. प्रभू रामचंद्रांच्या वास्तव्याने पुनीत झालेले येथील प्राचीन राममंदिर व सभोवतालचे पाण्याचे पात्र निवांत फिरण्यासाठी अतिशय आनंददायी आहे.",
      fullDescEn:
        "Located in Bahe on Krishna river, Ramling Island is a natural river island housing an ancient Ram temple associated with the Ramayana. Excellent for a scenic nature outing.",
      highlightsMr: [
    ...
    // ── LONGER DAY TRIPS (५० ते ८० किमी सहली) ──
    {
      ...
      shortDescEn:
        "UNESCO World Heritage tiger reserve, vast dam reservoir & lush green forest nature.",
      fullDescMr:
        "सह्याद्रीच्या कुशीत वसलेले चांदोली हे महाराष्ट्रातील प्रमुख राष्ट्रीय उद्यान आहे. चांदोली धरण, विशाल जलाशय व दाट जंगल गाडीतून पाहण्याचा अनुभव अविस्मरणीय असतो.",
      fullDescEn:
        "Part of the Sahyadri Tiger Reserve and UNESCO World Heritage site. Features the grand Chandoli Dam, massive water reservoir, and dense forest drives.",
      highlightsMr: [
    ...
    },
    {
      ...
      shortDescEn:
        "Spectacular 177 ft (52m) waterfall plunge with a historic British hanging suspension bridge.",
      fullDescMr:
        "घटप्रभा नदीवर १७७ फूट उंचीवरून कोसळणारा गोकाक धबधबा हा 'भारतातील नायगारा' म्हणून प्रसिद्ध आहे. धबधब्यावर असलेला १८८७ मधील लटकता पूल व दृश्य गाडीतून/व्ह्यू पॉइंटवरून सहजरीत्या पाहता येते.",
      fullDescEn:
        "Dropping 177 feet (52 meters) over a horseshoe cliff on Ghataprabha river, Gokak Falls resembles Niagara Falls. Features a historic 1887 hanging suspension bridge with easy viewing platforms.",
      highlightsMr: [
    ...
    },
    {
      ...
      fullDescMr:
        "छत्रपती शिवाजी महाराजांनी १६७६ मध्ये बांधलेला हा ऐतिहासिक किल्ला सांगली जिल्ह्यातील प्रमुख ऐतिहासिक ठिकाण आहे. किल्ल्यावर मच्छिंद्रनाथांची समाधी व सुंदर परिसर आहे.",
      fullDescEn:
        "Built by Chhatrapati Shivaji Maharaj in 1676, Machhindragad is a heritage fort featuring the revered Machhindranath shrine surrounded by pleasant hill views.",
      highlightsMr: [
    ...
    },
    {
      ...
      shortDescEn:
        "Easy 50km full-day trip for Shri Mahalaxmi Temple, New Palace Museum & Rankala Lake.",
      fullDescMr:
        "सांगलीपासून अवघ्या ५० किमी अंतरावर असलेले कोल्हापूर हे १ दिवसाच्या सहलीसाठी सर्वोत्तम स्थान आहे. करवीर निवासिनी श्री अंबाबाई मंदिर दर्शन, छत्रपती शाहू महाराजांचा न्यू पॅलेस राजवाडा व रंकाळा तलाव येथे व्हिलचेअर व सुलभ सोयी उपलब्ध आहेत.",
      fullDescEn:
        "Just 50 km from Sangli, Kolhapur makes a perfect full-day outing for Anandshala seniors. Visit the divine Shri Mahalaxmi Temple, Chhatrapati Shahu New Palace Museum, and scenic Rankala Lake.",
      highlightsMr: [
    ...
    <section className="as-sangli-wrapper" id="about-sangli">
      ...
      <div className="as-sangli-container">
        ...
        <div className="as-sangli-header">
          ...
          >
            ...
            <span>
              {isEn
                ? "Explore Sangli & Nearby Attractions"
                : "सांगली व परिसरातील १४ प्रमुख पर्यटन व तीर्थक्षेत्रे"}
            </span>
          </motion.div>
          ...
          >
            {isEn ? (
              ...
              <>
                <span className="text-[#db2777]">आनंदशाळेच्या</span>{" "}
                <span className="text-[#1A05A2]">परिसरातील प्रसिद्ध ठिकाणे</span>
              </>
            )}
          </motion.h2>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mb-10 bg-linear-to-r from-pink-600 via-purple-700 to-indigo-800 rounded-3xl p-6 sm:p-8 text-white shadow-2xl relative overflow-hidden"
        >
            ...
            <div className="space-y-2">
              <span className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/20 backdrop-blur-md text-white font-extrabold text-xs tracking-wider uppercase border border-white/30">
                ...
                {isEn ? (
                  <>
                    Tailored for{" "}
                    <span className="text-[#db2777] font-black bg-white px-2 py-0.5 rounded-full shadow-sm">
                      Anandshala
                    </span>{" "}
                    Seniors
                  </>
                  ...
                  <>
                    ...
                    ज्येष्ठांसाठी विशेष शिफारस
                  </>
                )}
              </span>
              <h3 className="text-2xl sm:text-3xl font-black leading-tight text-white">
                {isEn
                  ? "Comfortable & Easy Excursions (Zero Steep Climbs)"
                  : "ज्येष्ठांसाठी अत्यंत सोयीस्कर व विनासायास दर्शन सहली"}
              </h3>
          ...
          {filteredPlaces.map((place, idx) => (
            ...
            >
              ...
              <div className="as-sangli-card-body">
                ...
                <h3 className="as-sangli-card-title">{isEn ? place.titleEn : place.titleMr}</h3>
        ...
        <div className="mt-20">
          <div className="text-center mb-10">
            ...
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black text-[#1A05A2]">
              {isEn ? (
                ...
                <>
                  सांगली व <span className="text-[#db2777]">आनंदशाळेत</span>{" "}
                  <span className="text-[#1A05A2]">कसे पोहोचावे ?</span>
                </>
              )}
            </h3>
          ...
          <div className="as-sangli-transport-grid">
            ...
            >
              <div className="as-sangli-transport-icon-box bg-linear-to-r from-sky-500 to-blue-600">
                <Plane size={30} />
              </div>
              ...
              <ul className="as-sangli-transport-list">
                <li className="as-sangli-transport-item">
                  ...
                  <span>
                    {isEn ? (
                      <>
                        <strong>Kolhapur Airport (KLH):</strong> 45 km (45 mins by car)
                      </>
                    ) : (
                      <>
                        <strong>कोल्हापूर विमानतळ (Kolhapur):</strong> ४५ किमी (४५ मि. कारने)
                      </>
                    )}
                  </span>
                </li>
                <li className="as-sangli-transport-item">
                  ...
                  <span>
                    {isEn ? (
                      <>
                        <strong>Belagavi Airport (IXG):</strong> 95 km (1.5 hrs)
                      </>
                    ) : (
                      <>
                        <strong>बेळगाव विमानतळ (Belagavi):</strong> ९५ किमी (१.५ तास)
                      </>
                    )}
                  </span>
                </li>
                <li className="as-sangli-transport-item">
                  ...
                  <span>
                    {isEn ? (
                      <>
                        <strong>Pune International Airport:</strong> 230 km (3.5 hrs)
                      </>
                    ) : (
                      <>
                        <strong>पुणे आंतरराष्ट्रीय विमानतळ:</strong> २३० किमी (३.५ तास)
                      </>
                    )}
                  </span>
                </li>
            ...
            <motion.div
              ...
              className="as-sangli-transport-card"
            >
              <div className="as-sangli-transport-icon-box bg-linear-to-r from-purple-500 to-indigo-600">
                <Train size={30} />
              </div>
              ...
              <ul className="as-sangli-transport-list">
                <li className="as-sangli-transport-item">
                  ...
                  <span>
                    {isEn ? (
                      <>
                        <strong>Miraj Junction (MRJ):</strong> 10 km (Main Junction)
                      </>
                    ) : (
                      <>
                        <strong>मिरज जंक्शन (MRJ):</strong> १० किमी (मुख्य जंक्शन)
                      </>
                    )}
                  </span>
                </li>
                <li className="as-sangli-transport-item">
                  ...
                  <span>
                    {isEn ? (
                      <>
                        <strong>Sangli Station (SLI):</strong> 4 km (Near Anandshala)
                      </>
                    ) : (
                      <>
                        <strong>सांगली स्टेशन (SLI):</strong> ४ किमी (आनंदशाळेजवळ)
                      </>
                    )}
                  </span>
                </li>
                <li className="as-sangli-transport-item">
                  ...
                  <span>
                    {isEn
                      ? "Vande Bharat, Mahalaxmi, Koyna & Goa Express available"
                      : "वंदे भारत, महालक्ष्मी, कोयना व गोवा एक्सप्रेस सोय"}
                  </span>
                </li>
              </ul>
            </motion.div>
            ...
            <motion.div
              ...
              className="as-sangli-transport-card"
            >
              <div className="as-sangli-transport-icon-box bg-linear-to-r from-pink-500 to-rose-600">
                <Bus size={30} />
              </div>
              ...
              <ul className="as-sangli-transport-list">
                <li className="as-sangli-transport-item">
                  ...
                  <span>
                    {isEn ? (
                      <>
                        <strong>From Pune:</strong> 230 km (4 hrs via Highway)
                      </>
                    ) : (
                      <>
                        <strong>पुण्यावरून:</strong> २३० किमी (४ तास हायवेने)
                      </>
                    )}
                  </span>
                </li>
                <li className="as-sangli-transport-item">
                  ...
                  <span>
                    {isEn ? (
                      <>
                        <strong>From Mumbai:</strong> 380 km (6.5 hrs via Highway)
                      </>
                    ) : (
                      <>
                        <strong>मुंबईवरून:</strong> ३८० किमी (६.५ तास हायवेने)
                      </>
                    )}
                  </span>
                </li>
                <li className="as-sangli-transport-item">
                  ...
                  <span>
                    {isEn
                      ? "Daily MSRTC Shivneri, Volvo & private AC buses available"
                      : "दररोज MSRTC शिवनेरी, वॉल्व्हो व प्रायव्हेट बस सोय"}
                  </span>
                </li>
              </ul>
            </motion.div>
      ...
      {selectedPlace &&
        ...
        createPortal(
          ...
          >
            <div
              className="bg-white rounded-4xl sm:rounded-[2.5rem] max-w-lg w-full h-[84vh] sm:h-[88vh] max-h-160 sm:max-h-175 flex flex-col relative shadow-2xl border-4 border-pink-300 text-slate-800 overflow-hidden shadow-pink-500/30 my-auto shrink-0"
                  ...
                  <>
                    ...
                    <div className="pt-1 pb-2">
                      <a
                        ...
                        className="w-full py-3.5 px-4 rounded-2xl bg-linear-to-r from-emerald-600 via-teal-600 to-emerald-700 hover:opacity-95 text-white font-black text-xs sm:text-sm shadow-xl flex items-center justify-center gap-2 transition transform hover:scale-[1.01]"
                      >
