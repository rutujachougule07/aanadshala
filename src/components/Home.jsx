  ...
  return (
    <div className="min-h-screen bg-[#EEF3FF]">
      ...
      <nav className="w-full bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-425 mx-auto px-8 h-24 flex items-center justify-between">
          {/* Logo */}
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-[28px] sm:text-[34px] font-extrabold text-[#17286E] leading-none">
                Ã Â¤ÂªÃ Â¥ÂÃ Â¤Â°Ã Â¥â‚¬Ã Â¤Â¤Ã Â¤Â® Ã Â¤Å“Ã Â¥ÂÃ Â¤Â¯Ã Â¥â€¡Ã Â¤Â·Ã Â¥ÂÃ Â¤Â 
      ...
      <section className="max-w-425 mx-auto mt-8 px-8 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="inline-flex items-center gap-3 bg-[#FFF7F8] border border-pink-100 rounded-full px-6 py-3 shadow-sm w-fit">
              ...
              <p className="text-pink-400 font-semibold text-sm sm:text-base">
                ...
                Ã Â¤Â¸Ã Â¤Â¾Ã Â¤â€šÃ Â¤â€”Ã Â¤Â²Ã Â¥â‚¬
              </p>
            </div>
            ...
            <p className="mt-6 text-[20px] sm:text-[24px] leading-[36px] sm:leading-[42px] text-gray-600 max-w-xl">
              ...
              Ã Â¤Â¨Ã Â¤Â¾Ã Â¤â€”Ã Â¤Â°Ã Â¤Â¿Ã Â¤â€¢Ã Â¤Â¾Ã Â¤â€šÃ Â¤Å¡Ã Â¥ÂÃ Â¤Â¯Ã Â¤Â¾
              Ã Â¤Â¨Ã Â¤Â¿Ã Â¤Â°Ã Â¥â€¹Ã Â¤â€”Ã Â¥â‚¬ Ã Â¤â€ Ã Â¤Â°Ã Â¥â€¹Ã Â¤â€”Ã Â¥ÂÃ Â¤Â¯ Ã Â¤Âµ
              Ã Â¤â€ Ã Â¤Â¨Ã Â¤â€šÃ Â¤Â¦Ã Â¤Â¦Ã Â¤Â¾Ã Â¤Â¯Ã Â¥â‚¬
              Ã Â¤â€ Ã Â¤Â¯Ã Â¥ÂÃ Â¤Â·Ã Â¥ÂÃ Â¤Â¯Ã Â¤Â¾Ã Â¤Â¸Ã Â¤Â¾Ã Â¤Â Ã Â¥â‚¬ Ã Â¤Â¦Ã Â¤Â¾Ã Â¤Â°
              Ã Â¤Â¯Ã Â¥â€¡Ã Â¤Â¥Ã Â¥â€¡Ã Â¤Å¡ Ã Â¤â€°Ã Â¤ËœÃ Â¤Â¡Ã Â¤Â¤Ã Â¥â€¡...
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8">
              ...
              >
                ...
                <p className="text-gray-500 mt-2 text-sm">
                  ...
                  Ã Â¤ÂªÃ Â¤Â°Ã Â¤Â¿Ã Â¤ÂµÃ Â¤Â¾Ã Â¤Â°
                </p>
              </motion.div>
              ...
              >
                ...
                <h3 className="font-bold text-[#17286E] mt-4 text-2xl">
                  <CountUp end={26} duration={3} enableScrollSpy={true} scrollSpyOnce={true} />,{" "}
                  <CountUp end={27} duration={3} enableScrollSpy={true} scrollSpyOnce={true} />,{" "}
                  <CountUp end={28} duration={3} enableScrollSpy={true} scrollSpyOnce={true} />
                </h3>
              ...
              >
                ...
                <h3 className="font-bold text-[#17286E] mt-4 text-xl">
                  <CountUp end={11} duration={3} enableScrollSpy={true} scrollSpyOnce={true} />{" "}
                  Ã Â¤Â¤Ã Â¥â€¡{" "}
                  <CountUp end={5} duration={3} enableScrollSpy={true} scrollSpyOnce={true} />
                </h3>
          ...
          <div className="relative rounded-[35px] overflow-hidden shadow-2xl h-195">
            <Swiper
            ...
            >
              ...
              <SwiperSlide>
                <div className="relative h-full">
                  ...
                  <div className="absolute bottom-32 left-10 z-10">
                    ...
                    <p className="text-white mt-4 text-xl">Learn Ã¢â‚¬Â¢ Laugh Ã¢â‚¬Â¢ Live</p>
                  </div>
                </div>
              </SwiperSlide>
              ...
              <SwiperSlide>
                <div className="relative h-full">
                  ...
                  <div className="absolute bottom-32 left-10 z-10">
                    <h2 className="text-white text-5xl font-bold">Active Senior Life</h2>

                    <p className="text-white mt-4 text-xl">Health Ã¢â‚¬Â¢ Fun Ã¢â‚¬Â¢ Family</p>
                  </div>
                </div>
              </SwiperSlide>
              ...
              <SwiperSlide>
                <div className="relative h-full">
                  ...
                  <div className="absolute bottom-32 left-10 z-10">
                    <h2 className="text-white text-5xl font-bold">Healthy Lifestyle</h2>
                  </div>
                </div>
              </SwiperSlide>
            </Swiper>
            ...
            <div className="absolute bottom-0 left-0 w-full bg-[#0F2F8E] text-white py-7 px-8 flex justify-between items-center z-20">
              <div>
                <h3 className="font-bold text-2xl">Facilities Available</h3>
      ...
      <motion.section
        ...
        transition={{ duration: 1 }}
        className="max-w-425 mx-auto px-8 mt-16 mb-20"
      >
        {/* Heading */}

        <div className="flex justify-between items-center mb-10">
          <div>
            <p className="text-pink-400 font-semibold uppercase tracking-widest">OUR FACILITIES</p>

            <h2 className="text-5xl font-extrabold text-[#17286E] mt-3">
              Ã Â¤â€ Ã Â¤Â¨Ã Â¤â€šÃ Â¤Â¦Ã Â¤Â¶Ã Â¤Â¾Ã Â¤Â³Ã Â¥â€¡Ã Â¤Â¤Ã Â¥â‚¬Ã Â¤Â²
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-white rounded-[30px] overflow-hidden shadow-lg group hover:-translate-y-3 duration-300">
            ...
            <div className="p-7">
              ...
              <p className="text-gray-500 mt-3 leading-7">
                Ã Â¤Â¦Ã Â¤Â°Ã Â¤Â°Ã Â¥â€¹Ã Â¤Å“ Ã Â¤Â¸Ã Â¤â€¢Ã Â¤Â¾Ã Â¤Â³Ã Â¥â‚¬ Ã Â¤â€ Ã Â¤Â£Ã Â¤Â¿
          ...
          <div className="bg-white rounded-[30px] overflow-hidden shadow-lg group hover:-translate-y-3 duration-300">
            ...
            <div className="p-7">
              ...
              <p className="text-gray-500 mt-3 leading-7">
                Ã Â¤â€”Ã Â¤Â¾Ã Â¤Â£Ã Â¥â‚¬, Ã Â¤Â­Ã Â¤Å“Ã Â¤Â¨, Ã Â¤ÂµÃ Â¤Â¾Ã Â¤Â¦Ã Â¥ÂÃ Â¤Â¯
                Ã Â¤â€ Ã Â¤Â£Ã Â¤Â¿ Ã Â¤Â¸Ã Â¤Â¾Ã Â¤â€šÃ Â¤Â¸Ã Â¥ÂÃ Â¤â€¢Ã Â¥Æ’Ã Â¤Â¤Ã Â¤Â¿Ã Â¤â€¢
                Ã Â¤â€¢Ã Â¤Â¾Ã Â¤Â°Ã Â¥ÂÃ Â¤Â¯Ã Â¤â€¢Ã Â¥ÂÃ Â¤Â°Ã Â¤Â®.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[30px] overflow-hidden shadow-lg group hover:-translate-y-3 duration-300">
            ...
            <div className="p-7">
              ...
              <p className="text-gray-500 mt-3 leading-7">
                Ã Â¤ÂµÃ Â¤Â¿Ã Â¤ÂµÃ Â¤Â¿Ã Â¤Â§ Ã Â¤ÂªÃ Â¥ÂÃ Â¤Â¸Ã Â¥ÂÃ Â¤Â¤Ã Â¤â€¢Ã Â¥â€¡,
                Ã Â¤ÂµÃ Â¤Â°Ã Â¥ÂÃ Â¤Â¤Ã Â¤Â®Ã Â¤Â¾Ã Â¤Â¨Ã Â¤ÂªÃ Â¤Â¤Ã Â¥ÂÃ Â¤Â°Ã Â¥â€¡
                Ã Â¤â€ Ã Â¤Â£Ã Â¤Â¿ Ã Â¤Â®Ã Â¤Â¾Ã Â¤Â¸Ã Â¤Â¿Ã Â¤â€¢Ã Â¥â€¡
          ...
          <div className="bg-white rounded-[30px] overflow-hidden shadow-lg group hover:-translate-y-3 duration-300">
            ...
            <div className="p-7">
              ...
              <p className="text-gray-500 mt-3 leading-7">
                ...
                Ã Â¤Â®Ã Â¤Â¨Ã Â¥â€¹Ã Â¤Â°Ã Â¤â€šÃ Â¤Å“Ã Â¤Â¨Ã Â¤Â¾Ã Â¤Å¡Ã Â¥â€¡
                Ã Â¤ÂµÃ Â¤Â¿Ã Â¤ÂµÃ Â¤Â¿Ã Â¤Â§ Ã Â¤â€“Ã Â¥â€¡Ã Â¤Â³.
              </p>
            </div>
          </div>
        </div>
      ...
      <motion.section
        ...
        transition={{ duration: 1 }}
        className="max-w-425 mx-auto px-8 py-20"
      >
        {/* Heading */}
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 text-xl mt-5 max-w-3xl mx-auto">
            ...
            Ã Â¤â€ Ã Â¤Â°Ã Â¥â€¹Ã Â¤â€”Ã Â¥ÂÃ Â¤Â¯, Ã Â¤Â®Ã Â¤Â¨Ã Â¥â€¹Ã Â¤Â°Ã Â¤â€šÃ Â¤Å“Ã Â¤Â¨
            Ã Â¤â€ Ã Â¤Â£Ã Â¤Â¿ Ã Â¤Â¸Ã Â¤Â¾Ã Â¤Â®Ã Â¤Â¾Ã Â¤Å“Ã Â¤Â¿Ã Â¤â€¢
            Ã Â¤â€°Ã Â¤ÂªÃ Â¤â€¢Ã Â¥ÂÃ Â¤Â°Ã Â¤Â®Ã Â¤Â¾Ã Â¤â€šÃ Â¤Å¡Ã Â¥â€¡
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="relative rounded-[35px] overflow-hidden group shadow-xl">
            <img
              ...
              className="w-full h-162.5 object-cover group-hover:scale-110 duration-700"
            />
            ...
            <div className="absolute bottom-10 left-10 text-white z-10">
              ...
              <h2 className="text-5xl font-bold mt-5">Senior Cultural Festival</h2>

              <p className="mt-4 text-xl text-gray-200">Celebrate happiness together.</p>
            </div>
          </div>
          ...
          <div className="space-y-7">
            ...
            <div className="bg-white rounded-[30px] shadow-lg p-7 flex gap-6 hover:-translate-y-2 duration-300">
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-pink-400 font-semibold">Health Program</span>
                </div>

                <h2 className="text-2xl font-bold text-[#17286E] mt-4">Morning Yoga Session</h2>
            ...
            <div className="bg-white rounded-[30px] shadow-lg p-7 flex gap-6 hover:-translate-y-2 duration-300">
              ...
              <div>
                ...
                <h2 className="text-2xl font-bold text-[#17286E] mt-4">Music & Singing</h2>
            ...
            <div className="bg-white rounded-[30px] shadow-lg p-7 flex gap-6 hover:-translate-y-2 duration-300">
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-pink-400 font-semibold">Fun Activity</span>
                </div>

                <h2 className="text-2xl font-bold text-[#17286E] mt-4">Indoor Games Competition</h2>

                <p className="text-gray-500 mt-3">Chess, Carrom and many enjoyable activities.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-[#17286E] text-white mt-20 rounded-t-[60px]">
        <div className="max-w-425 mx-auto px-8 py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-300 mt-6 leading-8">
                Ã Â¤Â®Ã Â¤Â¹Ã Â¤Â¾Ã Â¤Â°Ã Â¤Â¾Ã Â¤Â·Ã Â¥ÂÃ Â¤Å¸Ã Â¥ÂÃ Â¤Â°Ã Â¤Â¾Ã Â¤Â¤Ã Â¥â‚¬Ã Â¤Â²
                Ã Â¤ÂªÃ Â¤Â¹Ã Â¤Â¿Ã Â¤Â²Ã Â¥â‚¬ Ã Â¤Å“Ã Â¥ÂÃ Â¤Â¯Ã Â¥â€¡Ã Â¤Â·Ã Â¥ÂÃ Â¤Â 
                Ã Â¤Â¨Ã Â¤Â¾Ã Â¤â€”Ã Â¤Â°Ã Â¤Â¿Ã Â¤â€¢
                Ã Â¤â€ Ã Â¤Â¨Ã Â¤â€šÃ Â¤Â¦Ã Â¤Â¶Ã Â¤Â¾Ã Â¤Â³Ã Â¤Â¾.
                Ã Â¤â€ Ã Â¤Â°Ã Â¥â€¹Ã Â¤â€”Ã Â¥ÂÃ Â¤Â¯, Ã Â¤â€ Ã Â¤Â¨Ã Â¤â€šÃ Â¤Â¦
                Ã Â¤â€ Ã Â¤Â£Ã Â¤Â¿ Ã Â¤Â¸Ã Â¤Â¾Ã Â¤Â®Ã Â¤Â¾Ã Â¤Å“Ã Â¤Â¿Ã Â¤â€¢
                Ã Â¤â€°Ã Â¤ÂªÃ Â¤â€¢Ã Â¥ÂÃ Â¤Â°Ã Â¤Â®Ã Â¤Â¾Ã Â¤â€šÃ Â¤Â¸Ã Â¤Â¾Ã Â¤Â Ã Â¥â‚¬
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-300">
                <li className="hover:text-pink-400 cursor-pointer duration-300">Home</li>

                <li className="hover:text-pink-400 cursor-pointer duration-300">About</li>

                <li className="hover:text-pink-400 cursor-pointer duration-300">Gallery</li>

                <li className="hover:text-pink-400 cursor-pointer duration-300">Events</li>

                <li className="hover:text-pink-400 cursor-pointer duration-300">Contact</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-300">Sangli, Maharashtra</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-300">info@aanandshala.in</p>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-blue-700 mt-16 pt-8 flex flex-col lg:flex-row justify-between items-center">
            <p className="text-gray-300">Ã‚Â© 2026 Preetam Aanandshala. All Rights Reserved.</p>
