...
export function SiteFooter() {
  ...
  return (
    <footer className="relative mt-0 overflow-hidden text-slate-800 bg-gradient-to-b from-[#fff5f8] via-[#fdf2f5] to-[#fbcfe8]/40 border-t border-rose-200 font-sans">
      {/* TOP ACCENT LINE */}
      <div
      ...
      <div className="relative z-10">
        <div className="container-page grid gap-12 py-16 md:grid-cols-3">
          ...
          <div className="space-y-6">
            ...
            <div
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-black border border-rose-200 text-[#810B38] bg-white/80 backdrop-blur-sm shadow-xs"
            >
          ...
          <div>
            <h4 className="text-sm uppercase tracking-[0.2em] font-black text-[#810B38] mb-6 flex items-center gap-3">
              <span className="w-8 h-[3px] bg-[#db2777] rounded-full"></span>
