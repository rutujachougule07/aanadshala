...
export function PageHero({ title, subtitle, badge, eyebrow, image }: PageHeroProps) {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(150deg, #F0F6FF 0%, #E0F2FE 45%, #DBEAFE 75%, #BFDBFE 100%)",
      }}
    >
      {/* Subtle ambient light blobs */}
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="absolute -top-24 -left-24 w-96 h-96 rounded-full blur-3xl animate-float"
          style={{
            background: "radial-gradient(circle, rgba(230,0,103,0.14) 0%, transparent 70%)",
          }}
        />
        <div
          className="absolute top-1/2 right-0 w-80 h-80 rounded-full blur-3xl animate-float-reverse"
          style={{
            background: "radial-gradient(circle, rgba(2,132,199,0.18) 0%, transparent 70%)",
          }}
        />
        <div
          className="absolute -bottom-16 left-40% w-64 h-64 rounded-full blur-3xl animate-float-side"
          style={{
            background: "radial-gradient(circle, rgba(12,35,112,0.12) 0%, transparent 70%)",
          }}
        />
      </div>
      ...
      <div
        ...
        style={{
          background: "linear-gradient(90deg, transparent, #f472b6, #0284C7, #1A05A2, transparent)",
        }}
      />
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(12,35,112,0.4) 1px, transparent 1px), linear-gradient(90deg, rgba(12,35,112,0.4) 1px, transparent 1px)",
      ...
      <div className="container-page relative z-10 text-center">
        ...
        <div className="flex items-center justify-center gap-3 mt-8 animate-fade-up delay-300">
          ...
          <div
            ...
            style={{ background: "#f472b6", boxShadow: "0 0 8px rgba(230,0,103,0.8)" }}
          />
          <div
            className="h-px flex-1 max-w-24"
