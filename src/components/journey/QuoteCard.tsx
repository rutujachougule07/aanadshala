...
function QuoteCard() {
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute -bottom-16 -right-16 size-80 rounded-full bg-[#1A05A2]/15 blur-3xl animate-pulse"
        style={{ animationDelay: "2s" }}
      />

      {/* MAIN LUXURY CARD CONTAINER */}
      <div className="relative overflow-hidden rounded-4xl bg-linear-to-br from-[#120838] via-[#1A0933] to-[#0A0D2A] text-white p-6 sm:p-8 md:p-10 shadow-[0_20px_50px_rgba(26,5,162,0.3)] border border-[#f472b6]/30 transition-all duration-500">
        ...
        <div className="flex justify-center relative z-10 mb-4">
          ...
          >
            <Sparkles
              className="size-3.5 text-[#FFD700] animate-spin"
        ...
        <div className="relative z-10 mb-4 flex justify-center">
          <motion.div
            ...
            className="grid size-12 sm:size-14 place-items-center rounded-2xl bg-linear-to-br from-[#f472b6] to-[#1A05A2] p-3 text-white shadow-[0_8px_20px_rgba(230,0,103,0.5)] border border-white/20"
          >
        ...
        <h2 className="relative z-10 text-center font-display text-2xl sm:text-3xl md:text-4xl font-black leading-tight tracking-tight">
          ...
          <span className="bg-linear-to-r from-[#FF66B2] via-[#FFA366] to-[#66B2FF] bg-clip-text text-transparent">
            सेवांचा अखंड प्रवास
          </span>
        </h2>
        ...
        <div className="relative z-10 flex items-center justify-center gap-3 my-4">
          <div className="h-0.25 w-12 bg-linear-to-r from-transparent via-[#f472b6] to-transparent" />
        ...
        <p className="relative z-10 max-w-2xl mx-auto text-center text-xs sm:text-sm md:text-base text-slate-200 font-medium leading-relaxed">
          “सन २००० पासून आजपर्यंत हजारो ज्येष्ठ नागरिकांच्या चेहऱ्यावर आनंद फुलविण्याचा आमचा प्रयत्न
          अखंड सुरू आहे. प्रत्येक दिवस नव्या आशेचा आणि प्रेमळ सहवासाचा प्रवास आहे.”
        </p>

        {/* AUTHOR BADGE */}
        <div className="relative z-10 text-center mt-3">
          <span className="text-[11px] sm:text-xs font-bold text-[#FF66B2]">— आनंदशाळा परिवार</span>
        </div>
            ...
            >
              <div className="rounded-2xl bg-white/10 border border-[#f472b6]/20 p-5 sm:p-6 backdrop-blur-sm text-center shadow-inner">
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed max-w-2xl mx-auto">
                  आनंदशाळा हा केवळ एक प्रकल्प नसून, ज्येष्ठांसाठी तयार केलेले एक हक्काचे आणि
                  प्रेमाचे निवास स्थान आहे. येथे शारीरिक, मानसिक आणि भावनिक आरोग्याची विशेष काळजी
                  घेतली जाते. भक्ती-सत्संग, योग-प्राणायाम, करमणूक आणि अद्ययावत वैद्यकीय सुविधेसह एक
                  परिपूर्ण व आनंदी जीवनशैली आम्ही प्रदान करतो.
                </p>
